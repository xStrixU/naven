...
export interface InputValueTooLong
  ...
  code: PrismaErrorCode.InputValueTooLong;
  meta: {
    column_name: string;
  };
}
...
export interface UniqueKeyViolation
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.UniqueKeyViolation;
  meta: {
    /**
...
export interface ForeignKeyViolation
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.ForeignKeyViolation;
  meta: {
    /**
     * Field name from one model from Prisma schema
     */
...
export interface StoredValueIsInvalid
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.StoredValueIsInvalid;
  meta: {
    /**
...
export interface TypeMismatch extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.TypeMismatch;
  meta: {
    /**
     * Concrete value provided for a field on a model in Prisma schema. Should be peeked/truncated if too long to display in the error message
     */
...
export interface TypeMismatchInvalidCustomType
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.TypeMismatchInvalidCustomType;
  meta: {
    /**
     * Database error returned by the underlying data source
     */
...
export interface QueryParsingFailed
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.QueryParsingFailed;
  meta: {
    /**
...
export interface QueryValidationFailed
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.QueryValidationFailed;
  meta: {
    /**
...
export interface RawQueryFailed extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.RawQueryFailed;
  meta: {
    code: string;
    message: string;
  };
...
export interface NullConstraintViolation
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.NullConstraintViolation;
  meta: {
    constraint: /* @todo */ object;
  };
}
...
export interface MissingRequiredValue
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.MissingRequiredValue;
  meta: {
    path: string;
  };
}
...
export interface MissingRequiredArgument
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.MissingRequiredArgument;
  meta: {
    argument_name: string;
    field_name: string;
    object_name: string;
...
export interface RelationViolation
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.RelationViolation;
  meta: {
...
export interface RelatedRecordNotFound
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.RelatedRecordNotFound;
  meta: {
    details: string;
  };
}
...
export interface InterpretationError
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.InterpretationError;
  meta: {
    details: string;
  };
}
...
export interface RecordsNotConnected
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.RecordsNotConnected;
  meta: {
    relation_name: string;
    parent_name: string;
    child_name: string;
...
export interface ConnectedRecordsNotFound
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.ConnectedRecordsNotFound;
  meta: {
    details: string;
  };
}
...
export interface InputError extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.InputError;
  meta: {
    details: string;
  };
}
...
export interface ValueOutOfRange extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.ValueOutOfRange;
  meta: {
    details: string;
  };
}
...
export interface TableDoesNotExist
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.TableDoesNotExist;
  meta: {
    table: string;
  };
}
...
export interface ColumnDoesNotExist
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.ColumnDoesNotExist;
  meta: {
    column: string;
  };
}
...
export interface InconsistentColumnData
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.InconsistentColumnData;
  meta: {
    message: string;
  };
}
...
export interface PoolTimeout extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.PoolTimeout;
  meta: {
...
export interface RecordRequiredButNotFound
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.RecordRequiredButNotFound;
  meta: {
    cause: string;
  };
}
...
export interface UnsupportedFeature
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.UnsupportedFeature;
  meta: {
    feature: string;
  };
}
...
export interface MultiError extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.MultiError;
  meta: {
    errors: string;
  };
}
...
export interface InteractiveTransactionError
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.InteractiveTransactionError;
  meta: {
    error: string;
  };
}
...
export interface QueryParameterLimitExceeded
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.QueryParameterLimitExceeded;
  meta: {
    message: string;
  };
}
...
export interface MissingFullTextSearchIndex
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.MissingFullTextSearchIndex;
...
export interface MongoReplicaSetRequired
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.MongoReplicaSetRequired;
  meta: Record<string, unknown>;
}
/**
...
export interface MissingFieldsInModel
  extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.MissingFieldsInModel;
  meta: {
    field: string;
...
export interface ValueFitError extends Prisma.PrismaClientKnownRequestError {
  code: PrismaErrorCode.ValueFitError;
  meta: {
    details: string;
  };
}
